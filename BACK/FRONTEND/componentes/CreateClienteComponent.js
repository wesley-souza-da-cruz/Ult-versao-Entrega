...
class CreateClienteComponent extends Component {
  ...
  componentDidMount() {
    if (this.state.id === "_add") {
      return;
        ...
        Cliente.getClienteById(this.state.id).then((res) => {
  ...
  saveOrUpdateCliente = (e) => {
    ...
    if (this.state.id === "_add") {
        ...
        ClienteService.updateCliente(clientes, this.state.id).then(
        (res) => {
          this.props.history.push("/clientes");
        }
      );
  ...
  getTitle() {
    if (this.state.id === "_add") {
      ...
      return <h3 className="text-center">Alterar Dados Do Cliente</h3>;
    }
  }
  render() {
    return (
                ...
                <form>
                  ...
                  <div className="form-group">
                    ...
                    <input
                      ...
                      onChange={this.changeUltimoNomeHandler}
                    />
                  </div>
                  <div className="form-group">
                    <label> Email: </label>
                  ...
                  <button
                    ...
                    onClick={this.saveOrUpdateCliente}
                  >
                    Salvar
                  </button>
                  <button
